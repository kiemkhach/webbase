...
public class NumConfigLab003 {
	private Integer id;
	private String siteId;
	private String siteSuperficies;
	...
	private String logo;
	private String moduleDrivePreviousYear;
	...
	public String getModuleDrivePreviousYear() {
		return moduleDrivePreviousYear;
	}

	public void setModuleDrivePreviousYear(String moduleDrivePreviousYear) {
	...
	public String getSiteSuperficies() {
		return siteSuperficies;
	}

	public void setSiteSuperficies(String siteSuperficies) {
